...
#SBATCH --output=logs/CT/OFF/off_possible/%A_%a_output.txt
#SBATCH --error=logs/CT/OFF/off_possible/%A_%a_err.txt
#SBATCH --ntasks=1
...
INPUT_DIR="Projects/CT/analysis/OFF"
OUTPUT_DIR="Projects/CT/analysis/OFF/off_possible"

# Define the Python script to run
PYTHON_SCRIPT="core/python/CT/OFF/off_possible_6.py"
