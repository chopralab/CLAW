...
#SBATCH --array=0-41  # Array indices for 100 jobs, with a check to only process 41 files
...
OzOFF_database_path="Projects/AMP/off_possible/AMP_OFF_Possible_species.parquet"
