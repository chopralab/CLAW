...
#SBATCH --output=logs/FAME/NP/notpossible/%A_%a_output.txt
#SBATCH --error=logs/FAME/NP/notpossible/%A_%a_err.txt
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem-per-cpu=8G
#SBATCH --time=01:00:00
#SBATCH --array=0-1  # Adjust based on the number of input files or tasks
...
DEFAULT_OZON_DIR="Projects/FAME/isomer_filter/"
DEFAULT_OZOFF_DIR="Projects/FAME/analysis/NP/"
DEFAULT_OUTPUT_DIR="Projects/FAME/notpossible/"
...
python core/python/FAME/NP/notpossible_6_NP.py \
    --ozon_dir "$ozon_dir" \
    --ozoff_dir "$ozoff_dir" \
