...
#SBATCH --output=logs/FAME/NP/match/match_3_CT_%A_%a_output.txt
#SBATCH --error=logs/FAME/NP/match/match_3_CT_%A_%a_err.txt
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=16G
#SBATCH --time=24:00:00
#SBATCH --array=0-1  # Array indices for 41 jobs
...
SAMPLE_INPUT_DIR="Projects/FAME/samples/OFF/"
OUTPUT_DIR="Projects/FAME/match/NP/"
PYTHON_SCRIPT="core/python/FAME/NP/match_3_CT_NP.py"  # Updated to match the Python script name
