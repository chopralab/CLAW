...
#SBATCH --output=logs/FAME/OFF/analysis/%A_%a_output.txt
#SBATCH --error=logs/FAME/OFF/analysis/%A_%a_err.txt
#SBATCH --ntasks=1
...
INPUT_DIR="Projects/FAME/group/OFF"
OUTPUT_DIR="Projects/FAME/analysis/OFF"
...
python core/python/FAME/OFF/analysis_5_CT_OFF.py \
  "$input_file_path" \
  "$HEIGHT" \
  "$WIDTH" \
  "$REL_HEIGHT" \
