...
#SBATCH --output=logs/FAME/OFF/group/%A_%a_output.txt
#SBATCH --error=logs/FAME/OFF/group/%A_%a_err.txt
#SBATCH --ntasks=1
...
input_dir="Projects/FAME/match/OFF/"
output_dir="Projects/FAME/group/OFF/"
...
python core/python/FAME/OFF/group_4_CT_OFF.py \
