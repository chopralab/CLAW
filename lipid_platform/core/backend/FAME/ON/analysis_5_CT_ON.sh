...
#SBATCH --job-name=analysis_5_FAME_ON_%A_%a
#SBATCH --output=logs/FAME/ON/analysis/%A_%a_output.txt
#SBATCH --error=logs/FAME/ON/analysis/%A_%a_err.txt
#SBATCH --ntasks=1
...
PYTHON_SCRIPT="core/python/FAME/ON/analysis_5_CT_ON.py"

# Define input and output directories
INPUT_DIR="Projects/FAME/group/ON/"
OUTPUT_DIR="Projects/FAME/analysis/ON/"
