...
#SBATCH --output=logs/FAME/ON/mzml/%j_output.txt
#SBATCH --error=logs/FAME/ON/mzml/%j_error.txt
...
INPUT_FOLDER="Projects/FAME/mzml/ON/"
OUTPUT_FOLDER="Projects/FAME/mzml_parsed/ON/"
...
PYTHON_SCRIPT="core/python/FAME/ON/mzml_parser_1_CT_ON.py"
