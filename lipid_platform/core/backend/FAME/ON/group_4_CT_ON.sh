...
#SBATCH --job-name=group_4_FAME_ON_%A_%a
#SBATCH --output=logs/FAME/ON/group/%A_%a_output.txt
#SBATCH --error=logs/FAME/ON/group/%A_%a_err.txt
#SBATCH --ntasks=1
...
# Define variables
PYTHON_SCRIPT="core/python/FAME/ON/group_4_CT_ON.py"
INPUT_DIR="Projects/FAME/match/ON"
OUTPUT_DIR="Projects/FAME/group/ON"
