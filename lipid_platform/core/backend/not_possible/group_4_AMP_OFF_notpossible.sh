...
#SBATCH --output=core/backend/logs/group/notpossible/group_4_AMP_notpossible_%A_%a_output.txt
#SBATCH --error=core/backend/logs/group/notpossible/group_4_AMP_notpossible_%A_%a_err.txt
#SBATCH --ntasks=1
...
input_dir="Projects/AMP/match/OFF/notpossible/"
output_dir="Projects/AMP/group/OFF/notpossible/"
...
python core/python/not_possible/group_4_AMP_OFF_notpossible.py "$input_file_path" "$STD_Only"
