...
#SBATCH --output=core/backend/logs/mzml_parser/OFF/mzml_parser_1_AMP_%j_output.txt
#SBATCH --error=core/backend/logs/mzml_parser/OFF/mzml_parser_1_AMP_%j_err.txt
#SBATCH --ntasks=1
...
mzml_data='Projects/AMP/mzml/AMP_OFF/'
...
python core/python/mzml_parser_1_AMP_OFF.py $mzml_data
