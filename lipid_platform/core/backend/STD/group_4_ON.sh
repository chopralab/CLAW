...
#SBATCH --output=core/backend/logs/group/group_4_STDon_%A_%a_output.txt
#SBATCH --error=core/backend/logs/group/group_4_STDon_%A_%a_err.txt
#SBATCH --ntasks=1
...
python core/python/STD/group_4_ON.py "$input_file_path"
