...
input_dir="Projects/STD/group/OFF/"
output_dir="Projects/STD/analysis/OFF/"
...
python core/python/STD/analysis_5_OFF.py "$input_file_path" 1000 2 0.5 "$ignore_columns_flag"
