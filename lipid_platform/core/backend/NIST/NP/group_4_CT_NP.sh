...
#SBATCH --output=logs/NIST/NP/group/group_4_CT_%A_%a_output.txt
#SBATCH --error=logs/NIST/NP/group/group_4_CT_%A_%a_err.txt
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem-per-cpu=8G
#SBATCH --time=10:00:00
#SBATCH --array=0-5  # Adjust this to the number of files you have

module load anaconda/2024.02-py311
source activate /scratch/negishi/iyer95/conda/CLAW

# Define hardcoded paths
INPUT_DIR="Projects/NIST/match/NP/"
OUTPUT_DIR="Projects/NIST/group/NP/"
STD_ONLY="Sample"
PYTHON_SCRIPT="core/python/NIST/NP/group_4_CT_NP.py"
