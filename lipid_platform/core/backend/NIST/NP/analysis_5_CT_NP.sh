...
#SBATCH --output=logs/NIST/NP/analysis/%A_%a_output.txt
#SBATCH --error=logs/NIST/NP/analysis/%A_%a_err.txt
#SBATCH --ntasks=1
...
PYTHON_SCRIPT="core/python/NIST/NP/analysis_5_CT_NP.py"

INPUT_DIR="Projects/NIST/group/NP/"
OUTPUT_DIR="Projects/NIST/analysis/NP/"
HEIGHT=500
WIDTH=2
REL_HEIGHT=0.5
