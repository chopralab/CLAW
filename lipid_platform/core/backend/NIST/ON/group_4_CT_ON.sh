...
#SBATCH --output=logs/NIST/ON/group/%A_%a_output.txt
#SBATCH --error=logs/NIST/ON/group/%A_%a_err.txt
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=8G
#SBATCH --time=10:00:00
#SBATCH --array=0-3 # Ensure this matches the number of input files
...
# Define variables
PYTHON_SCRIPT="core/python/NIST/ON/group_4_CT_ON.py"
INPUT_DIR="Projects/NIST/match/ON"
OUTPUT_DIR="Projects/NIST/group/ON"
