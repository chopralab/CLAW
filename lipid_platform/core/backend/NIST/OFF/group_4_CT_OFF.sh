...
#SBATCH --output=logs/NIST/OFF/group/%A_%a_output.txt
#SBATCH --error=logs/NIST/OFF/group/%A_%a_err.txt
#SBATCH --ntasks=1
...
input_dir="Projects/NIST/match/OFF/"
output_dir="Projects/NIST/group/OFF/"
...
python core/python/NIST/OFF/group_4_CT_OFF.py \
