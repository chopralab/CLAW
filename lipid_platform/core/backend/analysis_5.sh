...
input_file_path="df_group_4.parquet"
output_file_path="df_analysis_5.parquet"
height=1000
width=2
rel_height=0.5
...
python core/python/analysis_5.py "$input_file_path" "$output_file_path" "$height" "$width" "$rel_height"
