...
#SBATCH --output=logs/canola/OFF/match/%A_%a_output.txt
#SBATCH --error=logs/canola/OFF/match/%A_%a_err.txt
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=8G
#SBATCH --time=24:00:00
#SBATCH --array=0-3 # FOR canola
...
PYTHON_SCRIPT="core/python/canola/OFF/match_3_CT_OFF.py"  # Path to the Python script
DATABASE="lipid_database/OzOFF_database/Database_OzOFF.parquet"
INPUT_DIR="Projects/canola/samples/OFF/"
OUTPUT_DIR="Projects/canola/match/OFF/"
TOLERANCE=0.3
LOG_LEVEL="INFO"
