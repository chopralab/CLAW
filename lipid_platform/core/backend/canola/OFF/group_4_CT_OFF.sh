...
#SBATCH --output=logs/canola/OFF/group/%A_%a_output.txt
#SBATCH --error=logs/canola/OFF/group/%A_%a_err.txt
#SBATCH --ntasks=1
...
input_dir="Projects/canola/match/OFF/"
output_dir="Projects/canola/group/OFF/"
...
python core/python/canola/OFF/group_4_CT_OFF.py \
