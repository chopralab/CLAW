...
#SBATCH --output=logs/canola/OFF/analysis/%A_%a_output.txt
#SBATCH --error=logs/canola/OFF/analysis/%A_%a_err.txt
#SBATCH --ntasks=1
...
INPUT_DIR="Projects/canola/group/OFF"
OUTPUT_DIR="Projects/canola/analysis/OFF"
...
python core/python/canola/OFF/analysis_5_CT_OFF.py \
  "$input_file_path" \
  "$HEIGHT" \
  "$WIDTH" \
  "$REL_HEIGHT" \
