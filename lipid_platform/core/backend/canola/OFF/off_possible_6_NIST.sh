...
#SBATCH --output=logs/canola/OFF/off_possible/%A_%a_output.txt
#SBATCH --error=logs/canola/OFF/off_possible/%A_%a_err.txt
#SBATCH --ntasks=1
...
INPUT_DIR="Projects/canola/analysis/OFF"
OUTPUT_DIR="Projects/canola/analysis/OFF/off_possible"
OUTPUT_DIR_ZEROVALUES="Projects/canola/analysis/OFF/off_possible/zero"

# Define the Python script to run
PYTHON_SCRIPT="core/python/canola/OFF/off_possible_6.py"
