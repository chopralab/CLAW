...
#SBATCH --output=logs/NIST/ON/mzml/%j_output.txt
#SBATCH --error=logs/NIST/ON/mzml/%j_error.txt
...
INPUT_FOLDER="Projects/NIST/mzml/ON/"
OUTPUT_FOLDER="Projects/NIST/mzml_parsed/ON/"
...
PYTHON_SCRIPT="core/python/NIST/ON/mzml_parser_1_CT_ON.py"
