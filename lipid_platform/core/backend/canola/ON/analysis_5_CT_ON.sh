...
#SBATCH --output=logs/NIST/ON/analysis/%A_%a_output.txt
#SBATCH --error=logs/NIST/ON/analysis/%A_%a_err.txt
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=8G
#SBATCH --time=04:00:00
#SBATCH --array=0-5  # Adjust the array size based on the number of files
...
PYTHON_SCRIPT="core/python/NIST/ON/analysis_5_CT_ON.py"

# Define input and output directories
INPUT_DIR="Projects/NIST/group/ON/"
OUTPUT_DIR="Projects/NIST/analysis/ON/"
