...
if __name__ == "__main__":
    ...
    transition_summed_sizes = parser.save_and_measure_size(transition_summed_df, "Projects/AMP/mzml_parsed/ON/sum/df_transition_summed_1_AMP")
    OzESI_sizes = parser.save_and_measure_size(OzESI_df, "Projects/AMP/mzml_parsed/ON/df_mzml_parser_1_AMP")
