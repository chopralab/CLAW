...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 4:
        print("Usage: python match_3_AMP_OFF_notpossible.py <OzON_database.parquet> <sample_file.parquet> <output_dir>")
        sys.exit(1)

    # Parse command-line arguments
    OzON_database_path = sys.argv[1]
    sample_path = sys.argv[2]
    output_dir = sys.argv[3]

    # Load the input DataFrames
    logging.info(f"Loading OzOFF database from {OzON_database_path}")
    ...
    matcher = MatchLipids(OzON_database)
