...
if __name__ == "__main__":
    ...
    transition_summed_sizes = parser.save_and_measure_size(transition_summed_df, "df_transition_summed_OFF_1")
    OzESI_sizes = parser.save_and_measure_size(OzESI_df, "df_mzml_parser_OFF_1")
