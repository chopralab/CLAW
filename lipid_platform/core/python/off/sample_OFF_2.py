...
def main():
    ...
    OzESI_df = pd.read_parquet("df_mzml_parser_OFF_1.parquet")
    ...
    print("Saving the result to df_sample_2.parquet...")
    OzON_Data.to_parquet("df_sample_2.parquet", index=False, compression="brotli")
