        ...
        for filter_col in ['group_by_lipid']:
            ...
            for group in tqdm(unique_groups, desc=f"Processing {filter_col} groups"):
                ...
                for i, peak in enumerate(peaks):
                    metadata_columns = ['Parent_Ion', 'Product_Ion', 'Sample', 'Species', 'group_by_lipid', 'group_by_ion', 'Lipid', 'STD_RT_ON', 'STD_RT_OFF', 'STD_RT_Dif', 'Isomer']
                    ...
                    peak_data.append({
                        ...
                        'Isomer': metadata['Isomer']  # Include the Isomer column
                    })
