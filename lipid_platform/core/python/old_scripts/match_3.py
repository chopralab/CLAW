...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 4:
        print("Usage: python match_3.py <OzOFF_database.parquet> <OzON_database.parquet> <df_sample_2.parquet>")
        sys.exit(1)
    ...
    matched_data = "df_match_3.parquet"  # Save MatchedData output Parquet file
