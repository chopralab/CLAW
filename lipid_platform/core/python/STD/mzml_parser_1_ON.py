...
if __name__ == "__main__":
    ...
    transition_summed_sizes = parser.save_and_measure_size(transition_summed_df, "Projects/STD/mzml_parsed/ON/sum/df_transition_summed_1_FAME")
    OzESI_sizes = parser.save_and_measure_size(OzESI_df, "Projects/STD/mzml_parsed/ON/df_mzml_parser_1_FAME")
