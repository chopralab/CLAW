...
# packages <- c("plyr", "ggridges", "tidyverse", "readxl", "edgeR", 
#               "ggsignif", "stringr", "reshape2", "gtools", "tidyr", 
#               "ggbeeswarm", "ggrepel", "scales", "ggplot2", "cowplot", 
#               "limma", "writexl")
# 
...
# }
# 
# # Loading the packages after installation
