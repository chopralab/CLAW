...
blank_name = "Blank"
###want to add number of DB and chain legnth
...
for ij in lst:
    if ".csv" in ij:
        ...
        new_xcel_file_name_for_palak = "sig_lipids_count_subclasses/"+ij[:-4]+'_'+threshold+'_'+str(threshold_value)+'_.xlsx'

        new_file_name ="parsed_edgeR/"+ ij[:-4]+"_added_paresed"+'_.xlsx'
                ...
                if (df['type'][i]) == 'PCandSM':
                    ...
                    if 'PC' in xx:
                        if "Lyso" in xx:
                            ...
                            list_of_sig_lipids_sub_class.append("Lyso_PC")
                            lipid_log2FC.append(df['logFC'][i])

                            if df['logFC'][i] >0:
                                up_regulated.append("Lyso_PC")
                                up_regulated_values.append(df['logFC'][i])

                            elif df['logFC'][i] <0:
                                down_regulated.append("Lyso_PC")
                                down_regulated_values.append(df['logFC'][i])
                        elif "PCp" in xx:
                            
                            list_of_sig_lipids_sub_class.append("PCp")
                            lipid_log2FC.append(df['logFC'][i])

                            if df['logFC'][i] >0:
                                up_regulated.append("PCp")
                                up_regulated_values.append(df['logFC'][i])

                            elif df['logFC'][i] <0:
                                down_regulated.append("PCp")
                                down_regulated_values.append(df['logFC'][i])
                        elif "PCo" in xx:
                            
                            list_of_sig_lipids_sub_class.append("PCo")
                            lipid_log2FC.append(df['logFC'][i])

                            if df['logFC'][i] >0:
                                up_regulated.append("PCo")
                                up_regulated_values.append(df['logFC'][i])

                            elif df['logFC'][i] <0:
                                down_regulated.append("PCo")
                                down_regulated_values.append(df['logFC'][i])
                        elif "PC (" in xx:
                            
                            list_of_sig_lipids_sub_class.append("PC")
                            lipid_log2FC.append(df['logFC'][i])
                        ...
                        list_of_sig_lipids_sub_class.append("SM")
                    ...
                    if "Lyso" in xx:
                        ...
                        list_of_sig_lipids_sub_class.append("Lyso_PI")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("Lyso_PI")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("Lyso_PI")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PIp" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PIp")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PIp")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PIp")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PIo" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PIo")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PIo")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PIo")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PI (" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PI")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PI")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PI")
                            down_regulated_values.append(df['logFC'][i])
                    ...
                    if "Lyso" in xx:
                        ...
                        list_of_sig_lipids_sub_class.append("Lyso_PE")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("Lyso_PE")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("Lyso_PE")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PEp" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PEp")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PEp")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PEp")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PEo" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PEo")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PEo")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PEo")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PE (" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PE")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PE")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PE")
                            down_regulated_values.append(df['logFC'][i])
                    ...
                    if "Lyso" in xx:
                        ...
                        list_of_sig_lipids_sub_class.append("Lyso_PG")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("Lyso_PG")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("Lyso_PG")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PGp" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PGp")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PGp")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PGp")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PGo" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PGo")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PGo")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PGo")
                            down_regulated_values.append(df['logFC'][i])
                    elif "PG (" in xx:
                        
                        list_of_sig_lipids_sub_class.append("PG")
                        lipid_log2FC.append(df['logFC'][i])

                        if df['logFC'][i] >0:
                            up_regulated.append("PG")
                            up_regulated_values.append(df['logFC'][i])

                        elif df['logFC'][i] <0:
                            down_regulated.append("PG")
                            down_regulated_values.append(df['logFC'][i])



                elif "TAG" in (df['type'][i]):
                    list_of_sig_lipids_sub_class.append("TAG")
                    lipid_log2FC.append(df['logFC'][i])
                    ...
                    list_of_sig_lipids_sub_class.append(df['type'][i])
...
#######Ready to save
        ...
        parsed_data_dict= {}
        parsed_data_dict["sub_classes"]=list_of_sig_lipids_sub_class
        parsed_data_dict["Chain Length"]=chain_length
        parsed_data_dict["DB number"]=DB_number




        print(len(df),"DF")
        print(len(list_of_sig_lipids_sub_class),"SUB Classes")

        for i in my_list:
            parsed_data_dict[str(i)] = df[i]

        data_frame = pd.DataFrame(parsed_data_dict)



        data_frame.to_excel(new_file_name,index=None)
        ...
        lipid_classes = []
        counts = []
        for i in list_of_sig_lipids_sub_class:
            # print(i)
        ...
        print(len(list_of_sig_lipids_sub_class))
        ...
        for i in lipid_classes:
            counts.append(list_of_sig_lipids_sub_class.count(i))
            counts_up.append(up_regulated.count(i))
            counts_down.append(down_regulated.count(i))

        print(lipid_classes)
        print(list_of_sig_lipids_sub_class.count("TAGs1"))
        print(list_of_sig_lipids_sub_class.count("TAGs2"))
        ...
        for i in lipid_classes:
            ...
            for j in range (len(lipid_log2FC)):
                if list_of_sig_lipids_sub_class[j] == i:
                    print(list_of_sig_lipids_sub_class[j])
    ...
    ###Gets the sums of upregulated values
        ...
        if sum(counts) != 0:
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("sig_lipids.png")
            plt.tight_layout()
    ...
    ###UP_down_sig_all_in_one
        if sum(counts) != 0:
            ...
            plt.legend()
            plt.show()
            save_title_bar_up = "combined_bar_sub/"+bar_plot +str("counts_combined_bar_sub.png")
            ...
            plt.legend()
            plt.show()
            save_title_bar_up = "combined_bar_sub/"+bar_plot +str("LOG_FC_combined_bar_sub.png")
            ...
            plt.legend()
            plt.show()
            save_title_bar_up = "combined_bar_sub/"+bar_plot +str("Normalized_LOG_FC_combined_bar_sub.png")
        ...
        # creating the bar plot
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("_up_regulated.png")
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("_LOGFC_up_regulated.png")
            plt.tight_layout()
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("_LOGFC_NORMALIZED_up_regulated.png")
        ...
        if sum(counts_down) != 0:
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("_down_regulated.png")
            plt.tight_layout()
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("_NORMALIZED_down_regulated.png")
            ...
            save_title_bar_up = "sub_plots/bar/"+bar_plot +str("_LOGFC_Normalized_down_regulated.png")
            plt.tight_layout()
    ...
    ###PCA uncommented
        ...
        # show plot
        plt.show()
        save_title_PCA = "sub_plots/"+PCA_title +str("_PCA.png")
...
###new colors
        ...
        # save_title_pi = "sub_plots/pie/"+pi_title +str("_PIE_.png")
...
###new colors
        ...
        plt.title(pi_title.replace("_"," ")+" Total "+str(sum(counts)))
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0)
        save_title_pi = "sub_plots/pie/"+pi_title +str("_ALL_PIE_.png")
        # save_title_pi = save_title_pi.replace("_"," ")
        ...
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0)
        save_title_pi = "sub_plots/pie/"+pi_title +str("_UP_Regulated_PIE_.png")
        # save_title_pi = save_title_pi.replace("_"," ")
        ...
        plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0)
        save_title_pi = "sub_plots/pie/"+pi_title +str("_down_Regulated_PIE_.png")
        # save_title_pi = save_title_pi.replace("_"," ")
...
#         save_title_pi_log2 = "sub_plots/pie/"+pi_Log2_title +str("_PIE.png")
...
#         # plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0)
# # .replace("_"," ")
#         save_title_pi_log2 = "sub_plots/pie/"+pi_Log2_title +str("Normalized_PIE.png")
