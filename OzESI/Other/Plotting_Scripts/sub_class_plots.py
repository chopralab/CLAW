...
for ij in lst:
    if ".csv" in ij:
        ...
        new_xcel_file_name_for_palak = "sig_lipids_count_subclasses/"+ij[:-4]+'_'+threshold+'_'+str(threshold_value)+'subclass_count_.xlsx'

        new_file_name ="parsed_edgeR_filter/"+ij[:-4]+'_'+threshold+'_'+str(threshold_value)+'_.xlsx'
...
#######Ready to save
    ...
    ###UP_down_sig_all_in_one
        if sum(counts) != 0:
            ...
            plt.xticks([r + barWidth for r in range(len(lipid_classes))],lipid_classes,rotation=90)
